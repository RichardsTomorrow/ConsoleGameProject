...
namespace ConsoleGameProject
{
    public class CrewPerson
    {
        ...
        static string[] possibleTraits = new string[] { "Captain", "Paleontologist", "Archaeologist", "Geologist", "Stout", "Occultist", "Roboticist", "Priest", "Doctor", "Brave" }; //, "Conspiracist", "Bungersome" }; these two aren't ready yet
